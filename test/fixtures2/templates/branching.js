import { elemWithText, mountBlock, elem, insert, updateBlock, unmountBlock, text, addDisposeCallback, createInjector } from "@endorphinjs/endorphin";
...
function template$0Update(host, scope) {
	const { if$0, choose$0 } = scope;
	updateBlock(if$0);
	updateBlock(choose$0);
}

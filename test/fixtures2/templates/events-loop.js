import { elem, addStaticEvent, removeStaticEvent, elemWithText, insert, addDisposeCallback, createInjector, mountIterator, updateIterator, unmountIterator } from "@endorphinjs/endorphin";
